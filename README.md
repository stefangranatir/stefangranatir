...
- OpenGL rendering for visualizing LiDAR data in 2D space
- Prababilistic SLAM implementation from scratch
...
- ProjectModulus: low-level driver development, Raspberry Pi integration, redneding pipeline experimentation (currently in progress)
